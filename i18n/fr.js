export default {
    ...
    admin: {
        ...
        notification: {
            ...
            descriptionSuccess:
                'La description de %skill% a été changée avec succès',
    ...
    createProfile: {
        ...
        topics: 'Quels sujets vous intéressent ? Ne vous en faites pas vous pouvez modifier vos choix plus tard',
        submit: 'Envoyer',
    ...
    skills: {
        ...
        addNewSkill:
            'Ajoutez %skill% comme nouvelle compétence de cette catégorie',
        ...
        deleteSkillTopicSuccess:
            'Le sujet %topic% a bien été supprimé du skill',
    ...
    myProfile: {
        ...
        updateUserCertSuccess:
            'Les certifications ont été modifiées avec succès',
        updateUserCertError:
