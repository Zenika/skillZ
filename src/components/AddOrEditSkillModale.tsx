...
const AddOrEditSkillModale = ({
  ...
  return (
    <div className="flex flex-col my-16 mx-6 dark:bg-dark-light p-6 rounded-lg max-w-screen-lg w-full">
            ...
            {[1, 2, 3, 4, 5].map((index) => (
              ...
              >
                <Image
                  ...
                  width="32"
                />
                <span className="pl-2 pt-1">{t(`skillLevels.${index}`)}</span>
              </button>
            ))}
          </div>
          <div
            ...
            {[1, 2, 3, 4, 5].map((index) => (
              ...
              >
                <Image
                  ...
                  width="32"
                />
                <span className="pl-2 pt-1">{t(`desireLevels.${index}`)}</span>
              </button>
            ))}
          </div>
        </div>
