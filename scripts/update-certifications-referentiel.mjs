 ...
 * FORMAT DATA
 */
const certifications = certificationsData.map((cert) => `('${cert.name.replaceAll("'", "''")}', '${cert.certBody.replaceAll("'", "''")}', ${cert.verified})`)
...
writer.write("INSERT INTO \"Certification\" (\"name\", \"certBody\", \"verified\") VALUES\n")
...
console.log(`Referential Certifications successfully updated (${certifications.length} certifications).`)
